...
def send_verification_email(to_email: str, code: str):
    ...
    msg['From'] = SMTP_USER
    msg['To'] = to_email
    msg['Subject'] = "Подтверждение email — Quant"
    body = f"""
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
        ...
        <p style="color: #888; font-size: 13px;">Код действителен 10 минут. Если ты не регистрировался — просто игнорируй это письмо.</p>
    </div>
    """
